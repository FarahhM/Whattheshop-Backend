...
from .views import UserCreateAPIView ,ListApiView ,DetailApiView,UpdateApiView ,ListUserchocieApiView ,ItemCreateView,OrderCreateView
...
urlpatterns = [
    ...
    path('order/list/',ListUserchocieApiView.as_view(),name='orderlist-api'),
